...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        _______, RM_HUEU, RM_VALU, RM_SATU, _______, _______, _______, _______, _______, _______, _______, _______, _______, QK_BOOT,          _______,
        KC_CAPS, RM_HUED, RM_VALD, RM_SATD, _______, _______, _______, _______, _______, _______, _______, _______,          _______,          _______,
        _______,          _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, RM_NEXT, _______,
        _______, _______, _______,                            _______,                            _______, _______, _______, RM_SPDU, RM_PREV, RM_SPDD
    ),
};
// clang-format on
